    ...
    <div class="py-12">
        <div class="sm:ml-64">
            <div class="p-4 mt-8">
                ...
                <div class="w-full mx-auto bg-white rounded-lg shadow-lg overflow-hidden p-8 mb-6">
                    ...
                    <form method="POST" action="{{ route('visitors.checkout') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="unique_id" name="unique_id" required class="shadow-sm border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:border-green-500">
                        </div>
                        <div class="flex items-center justify-between">
                            <button type="submit" class="bg-gradient-to-r from-green-500 to-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition hover:from-green-600 hover:to-green-800">
                                Check-out
                            </button>
                        </div>
                    </form>
                ...
                <!-- Visitors Table -->
                <div class="">
                    <div class="flex items-center justify-center mb-6 rounded bg-gray-50 dark:bg-gray-800">
                        <div class="w-full p-4">
                            ...
                            <div class="w-full overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300 shadow-lg rounded-lg overflow-hidden">
                                    <thead class="text-xs font-semibold text-gray-900 uppercase bg-green-100 dark:bg-gray-700 dark:text-gray-400 sticky top-0 z-10">
                                        <tr>
                                            <th scope="col" class="px-6 py-3 border-b border-gray-300 dark:border-gray-600">ID</th>
                                            <th scope="col" class="px-6 py-3 border-b border-gray-300 dark:border-gray-600">Name</th>
                                            <th scope="col" class="px-6 py-3 border-b border-gray-300 dark:border-gray-600">Phone</th>
                                            <th scope="col" class="px-6 py-3 border-b border-gray-300 dark:border-gray-600">Check In</th>
                                            <th scope="col" class="px-6 py-3 border-b border-gray-300 dark:border-gray-600">Check Out</th>
                                            <th scope="col" class="px-6 py-3 border-b border-gray-300 dark:border-gray-600">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white dark:bg-gray-800">
                                        @foreach ($visitors as $visitor)
                                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-green-50 dark:hover:bg-gray-700 transition-all ease-in-out">
                                                <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">{{ $visitor->unique_id }}</td>
                ...
                <div id="visitorDetailsModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
                    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-lg bg-white transition ease-in-out duration-300 transform scale-95">
                        <div class="text-center">
                            <h3 class="text-lg font-medium text-gray-900">Visitor Details</h3>
                            <div class="mt-2 px-4 py-3">
                                <img id="visitorImage" src="" alt="Visitor Photo" class="w-full h-auto mb-4 rounded-lg">
                            ...
                            <div class="items-center px-4 py-3">
                                <button onclick="closeModal()" class="px-4 py-2 bg-green-500 text-white font-medium rounded-lg hover:bg-green-700 w-full">
                                    Close
                                </button>
                            </div>
                        </div>
